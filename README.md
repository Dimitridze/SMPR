...
Language R
  ...
  <p><a href="#LOO">2.3. Метод kwNN + Loo</a></p>
  <p><a href="#kNN">2.4.  kwNN</a></p>
...
2.2. Метод kNN + Loo ### <a name="kNN"></a>*
...
### 2.3 Метод kwNN + Loo ### <a name="kwNN"></a>*</a>
...
### Метод LOO:
Для каждого элемента выборки обучающей выборки происходит следующий алгоритм:
