...
В случае когда __P(y__) одинаковы для всех классо, то следует выбрать класс __у__, у которого в точке __x__, плотность больше.
...
Реализация задания по <a href="https://dimitridze.shinyapps.io/line/">ссылочке</a>  
Визуализация:  
