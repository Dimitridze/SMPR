...
stolp = function(points, classes,errors) {
  ...
  label = paste("   Ошибочный объект \n  Margin = ", badmargins[vubros-1], sep = "")
  text(vubros-1, badmargins[vubros-1], labels = label, pos=4, col = "red")
  
  label = paste("   Выброс \n  Margin = ", badmargins[vubros], sep = "")
  text(vubros, badmargins[vubros], labels = label, pos=4, col = "red")
